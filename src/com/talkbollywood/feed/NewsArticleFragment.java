...
/**
 * Fragment that shows a single news article.
 */
public class NewsArticleFragment extends Fragment implements ImageRequestListener{
    ...
    {
        mContentView = inflater.inflate(R.layout.news_article, null);
        ...
        shareButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                MainActivity parent = (MainActivity)NewsArticleFragment.this.getActivity();
    ...
    private void processContent(String rawContent)
    {
        ...
        {
            //String text = preProcessed.substring(textIndexStart, imageIndexStart);
            //insertTextView(text + "\r\n");
            ...
            if(isImageLink(imageSrc))
            {
                ...
                textIndexStart = imageIndexEnd+2;
            }
            else
            {
        ...
        String text = preProcessed.substring(textIndexStart, preProcessed.length());        
        insertTextView(text);
